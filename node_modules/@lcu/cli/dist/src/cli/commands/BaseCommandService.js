...
var BaseCommandService = /** @class */ (function () {
    ...
    BaseCommandService.prototype.ensureInquired = function (value, propName, message) {
    ...
    BaseCommandService.prototype.ensureInquiredOptions = function (value, propName, choices, message) {
        if (message === void 0) { message = null; }
        return __awaiter(this, void 0, void 0, function () {
            var answs;
            return __generator(this, function (_a) {
    ...
    BaseCommandService.prototype.inquir = function (questions, options, exitOnError, errMsg) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ques = questions;
                        if (options) {
                            ques = ques.filter(function (q) { return !options[q.name]; });
                        }
                        return [4 /*yield*/, inquirer_1.default.prompt(ques).catch(function (err) {
    ...
    BaseCommandService.prototype.loadLCUConfigTemplate = function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        path = this.pathJoin.apply(this, __spreadArrays(pathParts, ['lcu.json']));
        ...
        return new Promise(function (resolve, reject) {
            if (commands && commands.length > 0) {
                ...
                proc.q.on('killed', function (reason) {
                    _this.Ora.fail("Command execution failed for " + command + ": " + reason);
                });
                ...
                proc.q.on('failed', function () {
                    _this.Ora.fail("Failed execution of command: " + command);
                    reject(proc.stderr);
                });
    ...
    BaseCommandService.prototype.saveLCUConfig = function (lcuConfig) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.writeJson('lcu.json', lcuConfig)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    BaseCommandService.prototype.writeJson = function (file, val) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, fs_extra_1.writeJson(file, val, { spaces: '\t' })];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
