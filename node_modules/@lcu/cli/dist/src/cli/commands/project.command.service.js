...
exports.ProjectCommandService = void 0;
                        ...
                        return __generator(this, function (_b) {
                            switch (_b.label) {
                                ...
                                case 3:
                                    ...
                                    logger_1.Logger.Basic("Project: " + context.projectName);
                                    _b.label = 4;
                                case 4:
                                    _b.trys.push([4, 11, , 12]);
                                    logger_1.Logger.Basic("LCU Config Loading...");
                                ...
                                case 5:
                                    ...
                                    logger_1.Logger.Basic("Template repo " + templateRepoPath);
                                    return [4 /*yield*/, this.inquir(templateRepoPath, context)];
                                case 6:
                                    answers = _b.sent();
                                ...
                                case 9:
                                    context = _b.sent();
                                    logger_1.Logger.Basic("Inqueries processed");
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, this.inquir(questions, context)];
                    case 3:
                        answers = _a.sent();
                        repoTemplateTempPath = this.pathJoin(templatesRepoPath, answers.template || context.template);
                        return [4 /*yield*/, this.inquir(repoTemplateTempPath, context)];
                    case 4:
