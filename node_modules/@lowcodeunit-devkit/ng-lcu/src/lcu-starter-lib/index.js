...
exports.lcuStarterLib = void 0;
const schematics_1 = require("@angular-devkit/schematics");
const config_1 = require("@schematics/angular/utility/config");
const core_1 = require("@angular-devkit/core");
function lcuStarterLib(options) {
    return (host, context) => {
        ...
        const targetPath = core_1.normalize(project.root + '/src/lib');
        const solutionSource = schematics_1.apply(schematics_1.url('./files'), [
...
exports.lcuStarterLib = lcuStarterLib;
